...
return [
    ...
    */
    ...
    'default' => env('DB_CONNECTION', 'module'),
    ...
    */
    ...
    'connections' => [
        ...
        'base' => [
            ...
            'database' => env('DB_BASE_DATABASE', 'base'),
        ...
        'payment' => [
            ...
            'database' => env('DB_PAYMENT_DATABASE', 'payment'),
        ...
        'module' => [
            ...
            'database' => env('DB_MODULE_DATABASE', 'module'),
     ...
     |--------------------------------------------------------------------------
     |
     | Включать ли в мигрирование таблицы users, modules и т.д.
     |
     */

    'base_migrations' => env('BASE_MIGRATIONS', false),
